...
mkdir -p "/data/phillips/pcp-logs/hostname/2019/06/17"
...
cp tests/hardware_info_tests/pcp_logs/* /data/phillips/pcp-logs/hostname/2019/06/17
cp tests/hardware_info_tests/replacement_rules.json /etc/supremm/
